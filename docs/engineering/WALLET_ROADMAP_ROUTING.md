...
| P1 active | BBD-WAL-004 | Codex Sol, High | Software custody, owner-selected in-broker native unlock/backup surface, encrypted persistence, and zeroization | Functional suites green; bounded native/crypto API correction 4 active |
