...
| P1 active | BBD-WAL-004 | Codex Sol, High | Software custody, owner-selected in-broker native unlock/backup surface, encrypted persistence, and zeroization | Correction 2 Rust red accepted; Node-only red rerun active |
