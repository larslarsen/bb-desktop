...
| P2 active | BBD-RATE-001 | Grok Build, High | Bounded untrusted-provider parser/worker and deterministic aggregation after the process split exists | USD-only, opt-in/default-off provider contract frozen; test source authorized at the post-WAL-005 baseline |
