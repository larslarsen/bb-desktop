...
| P2 active | BBD-RATE-001 | Grok Build, High | Bounded untrusted-provider parser/worker and deterministic single-source selection after the process split exists | Coinbase ZEC/USD plus Kraken XMR/USD, opt-in/default-off; test source authorized at the post-WAL-005 baseline |
