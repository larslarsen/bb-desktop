# BBD-PAY-001 — Hermes UI diagnostic execution 03
...
Command: `CHROME_DEVEL_SANDBOX=/opt/google/chrome/chrome-sandbox BBD_PAY001_ARTIFACT_DIR=dist/pay001-ui-diagnostic03/ui-01 timeout --signal=TERM --kill-after=5s 300s xvfb-run -a dist/pay001-finish-verify01/runtime/electron test/paymentInbox.electron.js`
Exit: 1. Failed.

## Failure: configured ready empty payment state missing

The driver completed bootstrap successfully:
- `bootstrap-diagnostics.json`: outcome=success, phase=complete, elapsed 476ms, DOM identity verified, fixture storage ready, load-file resolved
...
```json
{
  "browser": { "pid": 728995, "Seccomp": "0", "NoNewPrivs": "0", "NSpid": "728995" },
  "renderer": { "pid": 729041, "Seccomp": "2", "NoNewPrivs": "1", "NSpid": "729041\\t4" }
}
```
...
- `dist/pay001-ui-diagnostic03/actor.txt`
- `dist/pay001-ui-diagnostic03/source-before.json`
- `dist/pay001-ui-diagnostic03/driver-source.js`
- `dist/pay001-ui-diagnostic03/preflight.json`
- `dist/pay001-ui-diagnostic03/runtime-before.json`
- `dist/pay001-ui-diagnostic03/syntax.stdout.log`
- `dist/pay001-ui-diagnostic03/syntax.stderr.log`
- `dist/pay001-ui-diagnostic03/syntax-metadata.json`
- `dist/pay001-ui-diagnostic03/ui.stdout.log`
- `dist/pay001-ui-diagnostic03/ui.stderr.log`
- `dist/pay001-ui-diagnostic03/ui-01/bootstrap-diagnostics.json`
- `dist/pay001-ui-diagnostic03/ui-01/sandbox-status.json`
- `dist/pay001-ui-diagnostic03/ui-01/ui-failure-diagnostics.json`
- `dist/pay001-ui-diagnostic03/ui-01/fixture-failure.png`
