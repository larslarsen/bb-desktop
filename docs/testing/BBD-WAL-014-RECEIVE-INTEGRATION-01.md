# WAL-014 exact source integration and committed secret scan
...
```json
{
  "commands": [
    ...
    },
    {
      ...
      "exit": 0,
      "output": "dc24d4e700eea05e152ec064edb8923266b273b8\n"
    },
    {
      "argv": [
        "git",
    ...
    },
    {
      ...
      "exit": 0,
      "output": "docs/testing/BBD-WAL-014-RECEIVE-GREEN-01.md\ndocs/testing/BBD-WAL-014-RECEIVE-GREEN-02.md\ndocs/testing/BBD-WAL-014-RECEIVE-GREEN-03.md\ndocs/testing/BBD-WAL-014-RECEIVE-RED-01.md\nwallet-broker/src/account_ui.rs\nwallet-broker/src/accounts.rs\nwallet-broker/src/session.rs\nwallet-broker/src/zec.rs\nwallet-broker/tests/account_management.rs\nwallet-broker/tests/account_native_ui.rs\n"
    },
    {
      "argv": [
        "git",
    ...
    },
    {
      "argv": [
        ...
        "commit",
        "-m",
        "Add native Zcash receive addresses and unsynced balance status"
      ],
      "exit": 0,
      "output": "[master aad0bdd00] Add native Zcash receive addresses and unsynced balance status\n 10 files changed, 1878 insertions(+), 5 deletions(-)\n create mode 100644 docs/testing/BBD-WAL-014-RECEIVE-GREEN-01.md\n create mode 100644 docs/testing/BBD-WAL-014-RECEIVE-GREEN-02.md\n create mode 100644 docs/testing/BBD-WAL-014-RECEIVE-GREEN-03.md\n create mode 100644 docs/testing/BBD-WAL-014-RECEIVE-RED-01.md\n"
    },
    {
      "argv": [
        "git",
      ...
      "exit": 0,
      "output": "aad0bdd003af823dd6cbfa55994e4692555b3d43\n"
    },
    {
      "argv": [
        "git",
    ...
    },
    {
      ...
      "exit": 0,
      "output": "1:55PM INF 5346 commits scanned.\n1:55PM INF scanned ~34036665 bytes (34.04 MB) in 2.26s\n1:55PM INF no leaks found\n"
    },
    {
      "argv": [
        "git",
    ...
    },
    {
      ...
      "exit": 0,
      "output": "aad0bdd003af823dd6cbfa55994e4692555b3d43\trefs/heads/master\n"
    }
  ],
  "accepted": true,
  "version": "Hermes Agent v0.18.2 (2026.7.7.2) \u00b7 upstream 67764dc0 \u00b7 local 10b6d1a9 (+1 carried commit)\nInstall directory: <home>/.hermes/hermes-agent\nInstall method: git\nPython: 3.11.15\nOpenAI SDK: 2.24.0",
  "head": "dc24d4e700eea05e152ec064edb8923266b273b8",
  "initial_status": "M package-lock.json\n M package.json\n M scripts/security-policy.js\n M test/securityPolicy.node.js\n M wallet-broker/src/account_ui.rs\n M wallet-broker/src/accounts.rs\n M wallet-broker/src/session.rs\n M wallet-broker/src/zec.rs\n M wallet-broker/tests/account_management.rs\n M wallet-broker/tests/account_native_ui.rs\n?? docs/testing/BBD-WAL-009-POLICY-RED-AND-NATIVE-LINT-01.md\n?? docs/testing/BBD-WAL-011-EXECUTABLE-GREEN-01.md\n?? docs/testing/BBD-WAL-014-RECEIVE-GREEN-01.md\n?? docs/testing/BBD-WAL-014-RECEIVE-GREEN-02.md\n?? docs/testing/BBD-WAL-014-RECEIVE-GREEN-03.md\n?? docs/testing/BBD-WAL-014-RECEIVE-RED-01.md",
  "session": {
    "id": "20260910_135447_092c4d",
  ...
  "input_hashes": {
    ...
    "wallet-broker/target/wal014-receive-green-03.json": "2caff230f91fe6c2fe03240c19e49ccdde4b1a604bb95cc68a867229f72001eb",
    ...
    "docs/testing/BBD-WAL-014-RECEIVE-RED-01.md": "ebe38f5d7e8a1efbf3d3bd408a425858ecf80e15f53ecda5eb9a705d21b0ce86",
    "docs/testing/BBD-WAL-014-RECEIVE-GREEN-03.md": "f21fd93c3d32354f528f928ab031348c0366ef79b521f1babe087c02d0b2c0c3"
  },
  "source_commit": "aad0bdd003af823dd6cbfa55994e4692555b3d43",
  "source_pushed": true,
  "final_hashes": {
    "wallet-broker/tests/account_management.rs": "817fa7972be4aebec3799a83ac998e572dd5b6f54c93683c5f16077069382e77",
    "wallet-broker/tests/account_native_ui.rs": "eaa1dbb0a9db410c41be7daaac6663dc07d369a6a0769b6460ecf7983382d560",
