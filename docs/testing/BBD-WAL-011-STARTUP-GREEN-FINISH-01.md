# WAL-011 completed application startup validation
...
```json
{
  "commands": [
    ...
    },
    {
      ...
      "exit": 0,
      "output": "c50d5011dbb2d6c6e3c2a3aa0159c503d3a412f0\n"
    },
    {
      "argv": [
        "git",
    ...
    },
    {
      ...
      "exit": 0,
      "output": "9:02AM INF scanned ~1935431210 bytes (1.94 GB) in 16.2s\n9:02AM INF no leaks found\n"
    }
  ],
  "accepted": true,
  "version": "Hermes Agent v0.18.2 (2026.7.7.2) \u00b7 upstream 67764dc0 \u00b7 local 10b6d1a9 (+1 carried commit)\nInstall directory: <home>/.hermes/hermes-agent\nInstall method: git\nPython: 3.11.15\nOpenAI SDK: 2.24.0",
  "head": "c50d5011dbb2d6c6e3c2a3aa0159c503d3a412f0",
  "initial_status": "M package-lock.json\n M package.json\n M scripts/security-policy.js\n M social-main.js\n M test/electronSecurity.node.js\n M test/securityPolicy.node.js\n?? docs/testing/BBD-WAL-009-POLICY-RED-AND-NATIVE-LINT-01.md\n?? docs/testing/BBD-WAL-011-EXECUTABLE-GREEN-01.md\n?? docs/testing/BBD-WAL-011-STARTUP-BUILD-RED-01.md\n?? docs/testing/BBD-WAL-011-STARTUP-GREEN-01.md\n?? docs/testing/BBD-WAL-011-STARTUP-MAIN-RED-01.md\n?? scripts/build-wallet-broker.js\n?? test/walletBrokerBuild.node.js\n?? test/walletStartup.node.js\n?? test/walletStartupSmoke.node.js",
  "session": {
    "id": "20260910_090154_3794cc",
  ...
  "input_hashes": {
    ...
    "wallet-broker/target/wal011-startup-green-01.json": "9035d3ee833ed2aa53f15a6844ffbb4cf701c14388999586fce5a27343eed688",
    "docs/testing/BBD-WAL-011-STARTUP-GREEN-01.md": "c2aa40bd4a44ead2dee3382a9a1bcb9e6886d4724e049bbc0ad86141fd0c7377"
  },
  "retained_proof": {
    "raw": "wallet-broker/target/wal011-startup-green-01.json",
    "sha256": "9035d3ee833ed2aa53f15a6844ffbb4cf701c14388999586fce5a27343eed688",
    "session": {
      "id": "20260910_085930_0dff59",
      "model": "poolside/laguna-s-2.1:free",
      "provider": "nous"
    },
    "passing_distinct_groups": 71,
    "artifact": {
    ...
    "both_falsifications_restored": true,
    "policy_baseline_unchanged": true,
    "audit_clean": true,
    "git_secret_scan_clean": true
  },
  "release_green": false,
  "final_hashes": {
    "social-main.js": "7047253ee27955b0838ec226cd1e49c4a7dca8c3cc2a54a776fb1211c8a820d0",
