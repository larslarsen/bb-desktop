# WAL016 falsification, rebuilt native window and security ratchet
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "exit": 101,
      "output": "   Compiling bitbook-wallet-broker v0.1.0 (<repo>/wallet-broker)\n    Finished `test` profile [unoptimized + debuginfo] target(s) in 4.29s\n     Running tests/account_management.rs (wallet-broker/target/debug/deps/account_management-c68a82dfe14ae99c)\n\nrunning 1 test\ntest wal016_idle_expiry_redacts_a_returned_copy_while_the_real_worker_finishes_and_unlock_reveals_it ... FAILED\n\nfailures:\n\n---- wal016_idle_expiry_redacts_a_returned_copy_while_the_real_worker_finishes_and_unlock_reveals_it stdout ----\n\nthread 'wal016_idle_expiry_redacts_a_returned_copy_while_the_real_worker_finishes_and_unlock_reveals_it' (126344) panicked at tests/account_management.rs:2202:5:\nassertion `left == right` failed\n  left: Some(0)\n right: None\nnote: run with `RUST_BACKTRACE=1` environment variable to display a backtrace\n\n\nfailures:\n    wal016_idle_expiry_redacts_a_returned_copy_while_the_real_worker_finishes_and_unlock_reveals_it\n\ntest result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 19 filtered out; finished in 5.90s\n\nerror: test failed, to rerun pass `--test account_management`\n",
      "timeout": false
    },
    {
      "argv": [
    ...
    },
    {
      "argv": [
        ...
        "json",
        "--report-path",
        "wallet-broker/target/wal016-final-01-gitleaks-dir.json",
        "."
      ],
      "exit": 1,
      "output": "7:46PM INF scanned ~2167368984 bytes (2.17 GB) in 19.5s\n7:46PM WRN leaks found: 352\n",
      "timeout": false
    }
  ],
  "session": {
    "id": "20260910_194428_ef1df0",
