# WAL-015 exact dependency authority and preserved policy baseline
...
```json
{
  "commands": [
    ...
    },
    {
      ...
      "exit": 0,
      "output": "ok WAL-015 current manifest has each reviewed live declaration exactly once and passes policy\nok WAL-015 rejects removing zcash_client_backend\nok WAL-015 rejects changing the zcash_client_backend version pin\nok WAL-015 rejects enabling default features for zcash_client_backend\nok WAL-015 rejects an extra zcash_client_backend feature\nok WAL-015 rejects a duplicate zcash_client_backend declaration\nok WAL-015 rejects a displaced zcash_client_backend declaration\nok WAL-015 rejects removing tonic\nok WAL-015 rejects changing the tonic version pin\nok WAL-015 rejects enabling default features for tonic\nok WAL-015 rejects an extra tonic feature\nok WAL-015 rejects a duplicate tonic declaration\nok WAL-015 rejects a displaced tonic declaration\nok WAL-015 rejects removing tokio\nok WAL-015 rejects changing the tokio version pin\nok WAL-015 rejects enabling default features for tokio\nok WAL-015 rejects an extra tokio feature\nok WAL-015 rejects a duplicate tokio declaration\nok WAL-015 rejects a displaced tokio declaration\nok WAL-015 rejects removing prost\nok WAL-015 rejects changing the prost version pin\nok WAL-015 rejects enabling default features for prost\nok WAL-015 rejects an extra prost feature\nok WAL-015 rejects a duplicate prost declaration\nok WAL-015 rejects a displaced prost declaration\nok WAL-015 rejects removing incrementalmerkletree\nok WAL-015 rejects changing the incrementalmerkletree version pin\nok WAL-015 rejects enabling default features for incrementalmerkletree\nok WAL-015 rejects an extra incrementalmerkletree feature\nok WAL-015 rejects a duplicate incrementalmerkletree declaration\nok WAL-015 rejects a displaced incrementalmerkletree declaration\nok WAL-015 rejects removing either reviewed Tonic TLS trust feature\nok WAL-015 rejects backend sync and Tor feature authority independently\nBitBook WAL-015 manifest policy tests passed (33).\n"
    },
    {
      "argv": [
        "node",
    ...
    },
    {
      ...
      "exit": 1,
      "output": "3:59PM INF scanned ~2162499079 bytes (2.16 GB) in 16s\n3:59PM WRN leaks found: 59\n"
    }
  ],
  "accepted": false,
  ...
  "unrelated_policy_edits_preserved": true,
