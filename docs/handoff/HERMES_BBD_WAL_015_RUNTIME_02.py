...
try:
    ...
    for extra in [['--test','zec_live_sync'],['--test','zec_live_transport'],['--test','zec_live_validation'],['--test','zec_live_recovery']]:
        row=command(cargo+extra,240)
        assert row['exit']==0 and not row.get('timeout'), 'focused test failed'
