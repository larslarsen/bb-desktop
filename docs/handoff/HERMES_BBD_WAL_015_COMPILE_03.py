...
try:
    ...
    row=command([str(Path.home()/'.cargo/bin/rustup'),'run','1.98.0','cargo','test','--manifest-path','wallet-broker/Cargo.toml','--locked','--offline','--no-default-features','--features','native-ui','--test','zec_live_sync','--test','account_management','--test','account_native_ui','--test','zec_live_transport','--test','zec_live_validation','--test','zec_live_recovery','--no-run'],360)
