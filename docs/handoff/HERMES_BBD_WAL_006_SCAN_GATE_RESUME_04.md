# Hermes Handoff — BBD-WAL-006 Scan Gate Resume 04
...
Correction Review 01, Scan Clippy Correction Review 02, Scan Gate Format Review 02, Scan Format
Correction Review 02, the complete frozen `zec_scan`, `zec_store`, and `zec_address` tests, and
