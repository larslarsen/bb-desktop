# Hermes Handoff — BBD-WAL-008 Phase-B Expected Red 02

You are **Jr Dev — Hermes**. This durable handoff is authoritative and supersedes
Expected Red 01.
...
03, Phase-B Format Stop Review 01, Phase-A Format Correction Source Review 01, and the
complete two-path test drop.
